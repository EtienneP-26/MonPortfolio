...
const softSkills = [
  ...
  { name: 'Communication', color: '#F9BC2F', desc: "Plus de 15 présentation de modules et projets" },
  { name: 'Autonomie', color: '#ACD68B', desc: "Plus de 35 projets EPITECH fait seul et plusieurs projets personnels." },
  { name: 'Créativité', color: '#e57373', desc: "Création de plusieurs logos pour mes differents projets et aime dessiner pendant mon temps libres." },
  { name: 'Adaptabilité', color: '#ba68c8', desc: "Savoir s’ajuster rapidement à de nouveaux contextes ou imprévus." },
]
